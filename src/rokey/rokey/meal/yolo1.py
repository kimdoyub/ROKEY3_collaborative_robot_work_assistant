...
YOLO_MODEL_FILENAME = "/home/rokey/ros2_ws/src/DoosanBootcamp3rd/dsr_rokey/pick_and_place_voice/resource/best.pt"

YOLO_MODEL_PATH = os.path.join(YOLO_MODEL_FILENAME)
YOLO_JSON_PATH = '/home/rokey/ros2_ws/src/DoosanBootcamp3rd/dsr_rokey/rokey/resource/class_name_tool.json'
...
class YoloModel:
    def __init__(self):
        ...
        print(self.reversed_class_dict)
